...
export const dict = {
  EN: {
    /* TitleBase - title variations */
    helpNearby: 'HELP! NEARBY',
    resourcesNearby: 'RESOURCES! NEARBY',
    aboutNearby: 'ABOUT! NEARBY',
    ...
    details: 'Details',
    detailsFallback:
      'Visit the link above for more information about this resource and available services.',
  ...
  ES: {
    /* TitleBase - title variations */
    helpNearby: '¡AYUDA! CERCA',
    resourcesNearby: '¡RECURSOS! CERCA',
    aboutNearby: '¡SOBRE! CERCA',

    /* ShelterResults / shared */
    whatToBring: 'Qué traer',
    noResults: 'Sin datos de refugios en esta área.',
    shelterCount: (n: number) =>
      `${n} refugio${n !== 1 ? 's' : ''} encontrado${n !== 1 ? 's' : ''}`,
    ...
    helperText:
      'Ingresa tu código postal, elige una categoría y encuentra recursos locales y nacionales cerca de ti.',
    showingNearCity: (city: string, state: string, zip: string) =>
      `Mostrando resultados cerca de ${city}, ${state} (${zip})`,
    showingNearZip: (zip: string) =>
      `Mostrando resultados cerca del código ${zip}`,
    ...
    noLocalResults:
      'No se encontraron resultados locales en esta área. Consulta los recursos nacionales abajo.',
    ...
    details: 'Detalles',
    detailsFallback:
      'Visita el enlace para más información sobre este recurso y los servicios disponibles.',
    eligibility: 'Elegibilidad',
    eligibilityText:
      'Los requisitos varían por programa y ubicación. Contacta directamente al recurso para confirmar.',
