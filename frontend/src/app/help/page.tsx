            ...
            <div style={{ position: 'relative', flex: 1 }}>
              ...
              <input
                ...
                style={{
                  ...
                  color: cardText,
                  borderTop: `1.5px solid ${locationError ? '#dc2626' : inputBorder}`,
                  borderBottom: `1.5px solid ${locationError ? '#dc2626' : inputBorder}`,
                  borderLeft: `1.5px solid ${locationError ? '#dc2626' : inputBorder}`,
                  borderRight: 'none',
                  outline: 'none',
                  boxSizing: 'border-box',
                }}
